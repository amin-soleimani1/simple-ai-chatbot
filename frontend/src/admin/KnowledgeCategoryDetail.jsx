...
function StructuredPriceTable({ category, knowledge, items, onReplace, onPriceSaved }) {
  ...
  const [activeActionEditor, setActiveActionEditor] = useState(null);
  ...
  function cancelBatch() {
    ...
    setActiveActionEditor(null); setBatchPercentageValue(""); setBatchDirection("increase"); setBatchError("");
  }
  async function saveBatch() {
    ...
    try {
      ...
      setActiveActionEditor(null); setBatchPercentageValue(""); setBatchDirection("increase");
    } catch { setBatchError("ذخیره تغییرات انجام نشد. دوباره تلاش کنید."); }
    finally { setBatchSaving(false); }
  }
  function cancelAdd() {
    if (addSaving) return;
    setActiveActionEditor(null); setAddWattValue(""); setAddPriceValue(""); setAddError("");
  }
  async function saveAdd() {
    ...
    try {
      ...
      setActiveActionEditor(null); setAddWattValue(""); setAddPriceValue("");
  ...
  async function toggleAvailability(item) {
    if (availabilitySavingWatts.has(item.watt)) return;
