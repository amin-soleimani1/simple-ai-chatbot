export default function WelcomeMessage() {
  return (
    <section className="relative isolate mx-auto w-full max-w-[34rem] overflow-hidden rounded-2xl border border-[#d9ad4a]/45 bg-[#161215] px-4 py-2.5 text-center shadow-[0_0_0_1px_rgba(238,198,103,0.08),0_10px_26px_rgba(0,0,0,0.38),0_0_22px_rgba(217,173,74,0.1),0_8px_20px_rgba(156,104,35,0.1)] sm:max-w-xl sm:px-5 sm:py-3">
