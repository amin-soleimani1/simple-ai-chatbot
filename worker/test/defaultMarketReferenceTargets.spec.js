...
describe("default market reference research targets", () => {
	...
	it("refines only Batch-2 identities with comparable strip and driver attributes", () => {
		...
		expect(byId("led-strips").targets).toEqual([{ variantId: "12v-single-color-5m", label: "ریسه نواری LED تک‌رنگ ۱۲ ولت کلاف ۵ متری", attributes: { voltage: 12, colorMode: "single-color", lengthM: 5 } }, { variantId: "24v-single-color-5m", label: "ریسه نواری LED تک‌رنگ ۲۴ ولت کلاف ۵ متری", attributes: { voltage: 24, colorMode: "single-color", lengthM: 5 } }, { variantId: "220v-single-color-1m", label: "ریسه LED تک‌رنگ ۲۲۰ ولت یک متری", attributes: { voltage: 220, colorMode: "single-color", lengthM: 1 } }]);
