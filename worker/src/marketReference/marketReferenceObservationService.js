...
export function validateResearchObservationTimestamp(value) {
...
export function validateResearchObservationBatch(batch) {
	...
	if (!Array.isArray(batch.observations)) throw validationError("Research Observation Batch observations must be an array.");
	for (const observation of batch.observations) {
		...
		validateResearchObservationTimestamp(observation.observedAt);
	}
	return batch;
}
